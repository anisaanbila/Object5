...
.timeline:before{ content:""; position:absolute; left:10px; top:4px; bottom:4px; width:3px;
  background:linear-gradient(#160078,#7226FF); border-radius:3px; }
.t-item{ position:relative; margin:.6rem 0; }
.t-item:before{ content:""; position:absolute; left:-3px; top:.35rem; width:14px; height:14px;
  border-radius:50%; border:3px solid rgba(255,255,255,.9); background:rgba(255,255,255,.15); }
.back-btn > button{
  all: unset; cursor:pointer; display:inline-flex; align-items:center; gap:.5rem;
  padding:.55rem .85rem; border-radius:12px; font-weight:800; color:#fff;
  background:rgba(255,255,255,.08); border:1px solid rgba(255,255,255,.12);
}
